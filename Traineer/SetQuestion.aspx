<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SetQuestion.aspx.cs" Inherits="Traineer.SetQuestion" %>
                                        ...
                                        <asp:DataGrid ID="grdData" class="table table-custom table-hover table-striped" runat="server" AutoGenerateColumns="false"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateColumn HeaderText="Action">
                                                    <ItemTemplate>
                                                        <asp:CheckBox runat="server" ID="chkSetQues" Checked='<%#Convert.ToBoolean(Eval("setId"))%>' />
                                                        <%--<asp:Label ID="lblSetQues" runat="server" Text='<%# Bind("setId") %>'/>--%>
                                                    </ItemTemplate>
                                                    <HeaderStyle HorizontalAlign="Center" Font-Bold="true" />
                                                    <ItemStyle HorizontalAlign="Center" />
                                                </asp:TemplateColumn>
