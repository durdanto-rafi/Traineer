<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Question.aspx.cs" Inherits="Traineer.Question" %>
                                    ...
                                    <ContentTemplate>
                                        <asp:DataGrid ID="grdData" class="table table-custom table-hover table-striped" runat="server" AutoGenerateColumns="false"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundColumn HeaderText="Question" DataField="Question">
                                                    <ItemStyle HorizontalAlign="Left" />
                                                    <HeaderStyle HorizontalAlign="Center" Font-Bold="true" />
                                                </asp:BoundColumn>
                                                <asp:BoundColumn HeaderText="Serial" DataField="Serial">
                                                    <ItemStyle HorizontalAlign="Center" />
                                                    <HeaderStyle HorizontalAlign="Center" Font-Bold="true" />
                                                </asp:BoundColumn>
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">
                                <asp:Label ID="lblModalTitle" runat="server" Text="Question Information"></asp:Label>
                            </h4>
                        </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12 col-xs-12">
                                                        <div class="form-group form-group-custom">
                                                            <label class="col-lg-2 col-xs-1 control-label small">Question</label>
                                                            <div class="col-lg-9 col-xs-11">
                                                                <div class="input-icon right">
                                                                    <asp:TextBox runat="server" class="form-control input-sm" Style="resize: none" TextMode="MultiLine" placeholder="Question" ID="txtQuestion" />
                                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ValidationGroup="validate" runat="server"
                                                                        ControlToValidate="txtQuestion" Display="Dynamic" SetFocusOnError="true" ForeColor="Red"
                                                                        ErrorMessage="Question Required" Style="font-size: xx-small">
                                        ...
                                        <asp:UpdatePanel runat="server" UpdateMode="Conditional" ChildrenAsTriggers="false">
                                            <ContentTemplate>
                                                <div class="row">
                                                    <div class="col-lg-12 col-xs-12">
                                                        <div class="form-group form-group-custom">
                                                            <label class="col-lg-2 col-xs-1 control-label small">Serial</label>
                                                            <div class="col-lg-9 col-xs-11">
                                                                <div class="input-icon right">
                                                                    <asp:TextBox runat="server" class="form-control input-sm" placeholder="Serial" ID="txtSerial" />
                                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ValidationGroup="validate" runat="server"
                                                                        ControlToValidate="txtSerial" Display="Dynamic" SetFocusOnError="true" ForeColor="Red"
                                                                        ErrorMessage="Serial Required" Style="font-size: xx-small">
                                                                    </asp:RequiredFieldValidator>
                                                                    <Ajax:FilteredTextBoxExtender ID="TextBox1_FilteredTextBoxExtender" runat="server"
                                                                        Enabled="True" TargetControlID="txtSerial" ValidChars="0123456789"></Ajax:FilteredTextBoxExtender>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
