<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Permission.aspx.cs" Inherits="Traineer.Permission" %>
                                ...
                                <div class="form-group form-group-custom">
                                    ...
                                    <div class="col-lg-7">
                                        <div class="input-icon right">
                                            <asp:DropDownList runat="server" class="form-control input-sm" ID="ddlUser" AutoPostBack="True"
                                        ...
                                        <asp:DataGrid ID="grdData" class="table table-custom table-hover table-striped" runat="server" AutoGenerateColumns="false"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateColumn HeaderText="Action">
                                                    <ItemTemplate>
                                                        <asp:CheckBox runat="server" ID="chkActive" Checked='<%#Convert.ToBoolean(Eval("Active"))%>' />
                                                    </ItemTemplate>
                                                    <HeaderStyle HorizontalAlign="Center" Font-Bold="true" />
                                                    <ItemStyle HorizontalAlign="Center" />
                                                </asp:TemplateColumn>
                                                <asp:BoundColumn HeaderText="Menu Name" DataField="MenuName">
